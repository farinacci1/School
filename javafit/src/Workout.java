...
public class Workout {
	...
	Workout(String name, Config.Equipment equipment, Config.Muscle primaryMuscle, Config.Muscle secondaryMuscle,
	...
	protected boolean hasPrimaryMuscle(ArrayList<Config.Muscle> muscleList) {
		for (Config.Muscle e : muscleList) {// This is a ForEach, and uses an iterator in the background to loop
													// through the collection.
			if (hasPrimaryMuscle(e))
				return true;
		}
		return false;
	}
